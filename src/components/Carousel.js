...
export const Carousel = () => {
    ...
    function handleCollectionButton(collectionId) {
        carouselControls.switchCollection(collectionId);
        carouselControls.updateBtns(collectionId);

        infoAnimation.hideInfo();

        setTimeout(() => {
            setSelectedCollection(collectionId);
            const newCollection = collections.find((c) => c.id === collectionId);
            setCurrentRankImage(RankImages[newCollection.Rank]);
        ...
        <div className="carousel">
            ...
            <div className="infoHolder">
                <div className="rankHolder">
                    ...
                    <h3>{selectedCollectionData?.Rank}</h3>
                </div>
                <h2>{selectedCollectionData?.Slogan}</h2>
                <h1 style={{ color: selectedCollectionData?.ThemeColor }}>
